...
if __name__ == "__main__":
	...
	for num_layers in num_layers_list:
		...
		model.fit(train_x, train_y, validation_data=(valid_x, valid_y), batch_size=64, nb_epoch=nb_epoch, show_accuracy=False, verbose=1, callbacks=[history, early_stopping, weight_image_saver, checkpointer])
